...
#'  @param remove_self_reported_cancer Logical. If \code{TRUE}, will remove individuals that self reported as having cancer. If \code{FALSE} (the default), will not exclude individuals with self reported cancer. 
#'
